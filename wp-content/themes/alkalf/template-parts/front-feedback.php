...
<section class="feedback" id="feedback">
    <div class="container">
        <div class="feedback__inner">
            ...
            <?php endif; ?>
            <?php if (!empty($gallery_feedback) && is_array($gallery_feedback)): ?>
                    ...
                    <div class="swiper-slide">
                        <div class="swiper__inner-two">
                            <div class="feedback_top">
                                <?php if (!empty($item['image_feedback']['url'])): ?>
                                ...
                                <div class="review_information">
                                    ...
                                    <?php endif; ?>
                                    <?php
                                    $stars = isset($item['stars_feedback']) ? intval($item['stars_feedback']) : 0;
                                    if ($stars > 0 && $stars <= 5): ?>
                            ...
                            <?php if (!empty($item['text_feedback'])): ?>
                                <div class="feedback__text">
                                    <?php echo esc_html(wp_trim_words($item['text_feedback'], 40, '...')); ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
